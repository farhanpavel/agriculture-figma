...
export default function page() {
  return (
    ...
    <p className='text-md'>Home  /  News</p>
    <h1 className='text-4xl'>News</h1>
      </div>
      <div className='mt-6'>
        <div className='flex flex-wrap justify-center  lg:justify-evenly gap-y-2 gap-x-2'>
            <div className='lg:w-1/3 md:w-1/4 '>


<div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img className="rounded-t-lg" src="https://images.nationalgeographic.org/image/upload/t_edhub_resource_key_image/v1638892233/EducationHub/photos/crops-growing-in-thailand.jpg" alt="" />
    </a>
    <div className="p-5">
        <a href="#">
